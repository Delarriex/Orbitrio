...
export const MobileNav: React.FC<MobileNavProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 bg-[#06080D]/95 backdrop-blur-xl border-t border-orbit-border/60 shadow-[0_-8px_30px_rgba(0,0,0,0.35)] lg:hidden pb-safe">
